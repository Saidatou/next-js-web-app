      ...
      <div className='container'>
...

        {
            loading ? (
              ...
              <div className='list-service grid lg:grid-cols-3 sm:grid-cols-2 gap-8 md:mt-6 gap-y-10'
              style={{ transform:isInView ? "none":'translateY(60px)', opacity:isInView?1:0,
