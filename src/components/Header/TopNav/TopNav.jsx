...
const TopNav = () => {
    ...
    return (
    <>
    <div className='bg-warning-600 text-red-400 font-bold text-center'>
        <div className='container items-center pt-2 h-[44px]'>
            Site vitrine réalisé avec du Php laravel et Next.Js
        </div>
    </div>
