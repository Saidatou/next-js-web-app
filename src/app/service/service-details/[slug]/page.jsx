...

    {
        ...
        (
            <main className="content">
                    <Breadcrumb link="Our Services Details" img="/images/header.webp" title={serviceDetails.service_name} desc={serviceDetails.service_short}  alt='' />
                ...
                <div className='content-detail-block lg:py-[100px] sm:py-16 py-10'>
                    ...
                    <Image width={5000} height={5000} className='w-full h-full rounded-xl' src={`${IMAGE_BASE_URL}/${serviceDetails.image}`} alt=''/> 
                    </div>
                ...
                <div className='ads-block rounded-lg md:mt-10 mt-6 relative'>
                    <div className='bg-img'>
                        <Image width={5000} height={5000} src='/images/ads.webp' alt='' /> 
                    </div>
