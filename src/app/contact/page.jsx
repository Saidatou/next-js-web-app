   ...
   // console.log(formData)
    ...
    return (
     ...
     <main className="content">
        <Breadcrumb link="Contact Us" img="/images/header.webp" title='Contact Us' desc="Get In touch with us"  alt=' '/> 
...
<div className='form-contact lg:py-[100px] sm:py-16 py-10'>
    ...
    <div className='list-more-infor md:mt-10 mt-6'>
       ...
       <div className='item flex items-center gap-3 mt-5'>
        ...
        <div className='line-y'></div>
        <div className='text-button normal-case text-white'>+33 1 02 00 00 00</div>
       </div>
       ...
       <div className='item flex items-center gap-3 mt-5'>
        ...
        <div className='line-y'></div>
        <div className='text-button normal-case text-white'>sbabatoherou@gmail.com</div>
       </div>
       ...
       <div className='item flex items-center gap-3 mt-5'>
        ...
        <div className='line-y'></div>
        <div className='text-button normal-case text-white'>Paris-France</div>
       </div> 
    </div> 
    </div> 
    </div>
